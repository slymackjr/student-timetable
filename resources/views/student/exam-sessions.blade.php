      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li>
              <a href="{{route('exam-sessions')}}" class="nav-link px-3 active">
                <span class="me-2"><i class="bi bi-calendar-check"></i></span>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Exam Sessions</h5>
    
                  <!-- Pills Tabs -->
                  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">First Week</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Second Week</button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Third Week</button>
                    </li>
                  </ul>
                        ...
                        <div class="col-md-12 mb-3">
                          <div class="card">
                            <div class="card-header">
                              <span><i class="bi bi-table me-2"></i></span> exam sessions
                            </div>
